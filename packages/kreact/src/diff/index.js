...
export function diff(
  ...
  try {
    // Add a update label so we can cancel if required
    update_block: {
      /*
      ...
      if (typeof new_type === "function") {
        let component, is_new, old_props, old_state;
        ...
        if (is_new) {
          ...
          if (
            ...
            // Break the update
            break update_block; // This will break and step out side the update_block
          }
        }
